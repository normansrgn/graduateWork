...
function HeaderNav() {
  ...
  // Проверяем, находится ли текущий путь внутри каталога или профиля
            ...
            >
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    style={{ stopColor: "rgb(6, 193, 252)", stopOpacity: 1 }}
                  />
                  <stop
                    offset="33%"
                    style={{ stopColor: "rgb(172, 66, 255)", stopOpacity: 1 }}
                  />
                  <stop
                    offset="57%"
                    style={{ stopColor: "rgb(255, 0, 214)", stopOpacity: 1 }}
                  />
                  <stop
                    offset="90%"
                    style={{ stopColor: "rgb(255, 0, 61)", stopOpacity: 1 }}
                  />
                </linearGradient>
              </defs>
